...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/contrib/mit/fxlib/rpc3.9/rpcgen/RCS/rpc_cout.c,v 1.3 1992/12/15 21:55:04 rr2b R6tape $";
#endif
