...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/contrib/mit/annot/RCS/stroffet.c,v 1.3 1992/12/15 21:50:50 rr2b R6tape $";
#endif
...
struct stroffet * self;
{
    ...
    stroffet_SetChild(self,to);
    stroffet_SetTitle(self,"FomatNote: Troff Commands");
    stroffet_SetSize(self, WIDTH, HEIGHT);
    return TRUE;
}
