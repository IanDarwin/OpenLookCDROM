static char *hwapp_rcsid = "$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/contrib/atkbook/hwanim/RCS/hwapp.c,v 1.1 1992/10/06 22:18:43 susan R6tape $";
...
struct hwapp *self;
{
    ...
    if (self->t == NULL || self->tv == NULL) return(FALSE);
