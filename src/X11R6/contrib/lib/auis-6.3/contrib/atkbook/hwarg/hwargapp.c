static char *hwargapp_rcsid = "$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/contrib/atkbook/hwarg/RCS/hwargapp.c,v 1.1 1992/10/06 22:19:11 susan R6tape $";
