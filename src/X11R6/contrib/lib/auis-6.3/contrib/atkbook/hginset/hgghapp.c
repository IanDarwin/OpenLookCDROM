static char *hgghapp_rcsid = "$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/contrib/atkbook/hginset/RCS/hgghapp.c,v 1.1 1992/10/06 22:17:38 susan R6tape $";
