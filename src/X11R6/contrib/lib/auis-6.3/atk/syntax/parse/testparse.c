...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/atk/syntax/parse/RCS/testparse.c,v 1.4 1992/12/15 21:43:33 rr2b R6tape $";
#endif
...
main()
{
	...
	p = parse_Create(&parse_description, 
		lexan_New(),  reduceActions,  NULL, NULL);
	parse_SetDebug(TRUE);
