...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/atk/examples/ex17/RCS/hellov.c,v 2.8 1992/12/15 21:33:36 rr2b R6tape $";
#endif
...
long height; 
{
	...
	/* if on white backvround, draw a rectangle around it */
