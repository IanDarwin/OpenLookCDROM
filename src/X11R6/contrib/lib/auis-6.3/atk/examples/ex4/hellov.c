...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/atk/examples/ex4/RCS/hellov.c,v 2.8 1992/12/15 21:34:22 rr2b R6tape $";
#endif
...
static struct bind_Description helloworldviewBindings[]={
    {"helloworld-center", "\003",0, NULL,0,0, Center, "Center the helloworld string."},
    {"helloworld-invert", "\011",0, NULL,0,0, Invert, "Invert the helloworld string."},
    NULL
};
    ...
    struct classheader *classID;
{
    ...
    bind_BindList(helloworldviewBindings, helloworldviewKeymap,NULL,&helloworldview_classinfo);
    return TRUE;
}
