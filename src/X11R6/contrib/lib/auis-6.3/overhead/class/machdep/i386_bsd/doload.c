...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/overhead/class/machdep/i386_bsd/RCS/doload.c,v 1.3 1994/05/19 16:24:15 rr2b Exp $";
#endif
...
struct doload_environment *e;
{
	...
	printf( "\nHEADER\n  magic= %x\n  text = %x\n  data = %x\n\
  bss  = %x\n  syms = %x\n  entry= %x\n  trsize=%x\n  drsize=%x\n",
		N_GETMAGIC(e->header), e->header.a_text, e->header.a_data,
