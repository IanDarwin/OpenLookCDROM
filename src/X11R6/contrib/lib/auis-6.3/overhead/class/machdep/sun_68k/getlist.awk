...
#  want[library["_class_Header"] "." definer["_class_Header"]] = "Y";
  ...
  if (definer["_getpwuid"] != "") 
	want[library["_getpwuid"] "." definer["_getpwuid"]] = "Y";
  if (definer["_clntudp_create"] != "") 
	want[library["_clntudp_create"] "." definer["_clntudp_create"]] = "Y";
  if (definer["_authnone_create"] != "") 
	want[library["_authnone_create"] "." definer["_authnone_create"]] = "Y";
  if (definer["_authunix_create"] != "") 
	want[library["_authunix_create"] "." definer["_authunix_create"]] = "Y";
