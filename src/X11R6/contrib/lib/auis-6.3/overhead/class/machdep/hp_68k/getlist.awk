...
#  want[library["_bzero"] "." definer["_bzero"]] = "Y";
  ...
  want[library["_memcmp"] "." definer["_memcmp"]] = "Y";
  want[library["_memcpy"] "." definer["_memcpy"]] = "Y";
  want[library["_memset"] "." definer["_memset"]] = "Y";
...
# definitions added for 7.0 **JG
  want[library["__fflush"] "." definer["__fflush"]] = "Y";
  want[library["__fclose"] "." definer["__fclose"]] = "Y";
  want[library["flag_68881"] "." definer["flag_68881"]] = "Y";
  want[library["_setjmp"] "." definer["_setjmp"]] = "Y";
  want[library["_longjmp"] "." definer["_longjmp"]] = "Y";
  want[library["__setjmp"] "." definer["__setjmp"]] = "Y";
  want[library["__longjmp"] "." definer["__longjmp"]] = "Y";
  want[library["__environ"] "." definer["__environ"]] = "Y";
  want[library["____exit"] "." definer["____exit"]] = "Y";
#additional entries
  want[library["_main"] "." definer["_main"]] = "Y";
  want[library["flag_68010"] "." definer["flag_68010"]] = "Y";
  want[library["flag_68881"] "." definer["flag_68881"]] = "Y";
  want[library["flag_fpa"] "." definer["flag_fpa"]] = "Y";
  want[library["float_loc"] "." definer["float_loc"]] = "Y";
  want[library["float_soft"] "." definer["float_soft"]] = "Y";
  want[library["fpa_loc"] "." definer["fpa_loc"]] = "Y";
