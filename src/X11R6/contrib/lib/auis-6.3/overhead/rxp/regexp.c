...
#ifndef NORCSID
#define NORCSID
static char rcsid[]="$Header: /afs/cs.cmu.edu/project/atk-dist/auis-6.3/overhead/rxp/RCS/regexp.c,v 2.8 1993/02/08 21:40:34 rr2b Exp $";
#endif
