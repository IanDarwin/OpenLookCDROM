...
#include <hp300_80/system.h>
        SYSTEM_H_FILE = hp300_80/system.h
#undef In_Imake
...
/* In order to handle all the defines needed for im.c */
        STD_DEFINES = +z -W p,-H1000000

        SUPLIBS = $(BASEDIR)/lib/libossup.a
        DYN_LINK_LIB = -ldld
        CLASS_ROUTINESTRUCT = _class_RoutineStruct
        MATHLIB =
        CURSESLIBS = -lcurses
