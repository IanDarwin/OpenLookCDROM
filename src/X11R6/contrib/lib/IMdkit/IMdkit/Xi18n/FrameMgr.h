...
#else
FrameMgr FrameMgrInit();
void FrameMgrInitWithData();
void FrameMgrFree();
FmStatus FrameMgrSetBuffer();
FmStatus FrameMgrPutToken();
FmStatus FrameMgrGetToken();
FmStatus FrameMgrSetSize();
FmStatus FrameMgrSetIterCount();
int FrameMgrGetTotalSize();
int FrameMgrGetSize();
FmStatus FrameMgrSkipToken();
void FrameMgrReset();
Bool FrameMgrIsIterLoopEnd();
#endif
