...
Xi18nClient *
#if NeedFunctionPrototypes
_Xi18nNewClient(Xi18n i18n_core)
#else
_Xi18nNewClient(i18n_core)
Xi18n i18n_core;
#endif
{
...
Xi18nClient *
#if NeedFunctionPrototypes
_Xi18nFindClient(Xi18n i18n_core, CARD16 connect_id)
#else
_Xi18nFindClient(i18n_core, connect_id)
Xi18n i18n_core;
CARD16 connect_id;
#endif
{
...
void
#if NeedFunctionPrototypes
_Xi18nDeleteClient(Xi18n i18n_core, CARD16 connect_id)
#else
...
void
#if NeedFunctionPrototypes
_Xi18nSendTriggerKey(XIMS ims, CARD16 connect_id)
#else
