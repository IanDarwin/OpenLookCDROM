...
float Mcodec_set_ger(struct bba_info *, float gain);
float Mcodec_get_ger(struct bba_info *);
int Mcodec_get_output(struct bba_info *);
void Mcodec_set_output(struct bba_info *, int enable, int rmask);
void Mcodec_set_input(struct bba_info *, int enable, int mask);
int Mcodec_get_input(struct bba_info *);

void Mcodec_init(struct bba_info *);
ATime bba_get_time(struct bba_info *);

void Mcodec_atg(struct bba_info *, double, double, double *, double *);
double Mcodec_stg();
void Mcodec_ger(struct bba_info *, int);
void Mcodec_gr(struct bba_info *, int);
double Mcodec_gx(struct bba_info *, int);
void Mcodec_mute(struct bba_info *, int);
double Mcodec_preamp(struct bba_info *, int);
void Mcodec_indirect(struct bba_info *, int, int, unsigned char *, int);
