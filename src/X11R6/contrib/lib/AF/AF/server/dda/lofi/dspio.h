...
extern void enableHostRxInt(struct lofi_info *lofi);
extern void hostCommand(struct lofi_info *lofi, int vector);
extern void writeHostData(struct lofi_info *lofi, int d);
