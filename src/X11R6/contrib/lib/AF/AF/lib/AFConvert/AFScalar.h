/*static char rcsid[] = "$RCSfile: AFScalar.h,v $, $Revision: 1.1 $, $Date: 1994/02/01 16:46:28 $";*/
...
/************************************************************************
 *
 * FILE NAME		: $RCSfile: AFScalar.h,v $
 * AUTHOR		: $Author: stewart $
 * DATE			: $Date: 1994/02/01 16:46:28 $
 * REVISION		: $Revision: 1.1 $
 * DESCRIPTION		: Scalar audio compression
 *
 * REVISION HISTORY
 *
 * $Log: AFScalar.h,v $
...
/* AFConvert_InitScalar is a null procedure, more or less */
extern
