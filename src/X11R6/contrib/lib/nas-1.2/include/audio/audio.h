 ...
 * 
 * $NCDId: @(#)audio.h,v 1.35 1994/01/14 17:51:35 greg Exp $
 */
...
#define AuComponentUseAllMasks	       ((1L << 2) - 1)
...
/*
 * Component Line Levels.  These determine which amplifier circuits are used,
 * typically to select between low gain pathways for CD players and other
 * line-level devices and high gain pathways for microphones and record 
 * players. 
 */
#define AuDeviceLineModeNone			(0L)
#define AuDeviceLineModeLow			(1L)
#define AuDeviceLineModeHigh			(2L)
