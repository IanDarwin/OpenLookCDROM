/* $Id: ptyx.h,v 3.0 1994/06/04 07:36:02 ygz Exp $ */
/***********************************************************************
...
#ifdef HANZI
#define	ATTRIBUTES	0x87	/* mask: user-visible attributes */
#else  /* HANZI */
...
#ifdef HANZI
#define FIRSTBYTE	0x40	/* is the first byte in a Hanzi (internal) */
#define CHARHANZI	0x80	/* is part of a Hanzi   (global & visible) */
#endif /* HANZI */
/* global flags */
...
# define FGCSinScreen(s,f)	\
		(((f) & BOLD) ? (s)->hz_boldFGCS : (s)->hz_normalFGCS)
#endif /* HANZI */
