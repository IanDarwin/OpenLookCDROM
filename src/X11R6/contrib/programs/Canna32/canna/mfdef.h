...
#define CANNA_FN_Nop			55 /* 何もしない(表示を返す) */

/* Version 2.1 には入っていない機能 */

#define CANNA_FN_HenkanOrInsert		56 /* 変換もしくは self-insert */
...
#define CANNA_FN_FuncSequence		74 /* 複数の機能の割り当て */
#define CANNA_FN_UseOtherKeymap		75 /* キーシーケンスの対応 */
