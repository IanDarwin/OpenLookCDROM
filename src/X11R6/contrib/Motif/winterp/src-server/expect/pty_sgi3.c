...
*
* File:         pty_sgi3.c
* RCS:          $Header: /users/npm/src/winterp/src-server/expect/RCS/pty_sgi3.c,v 2.4 1994/06/06 15:43:06 npm Exp $
* Description:  routines to allocate ptys - silicon graphics version
* Author:       Don Libes, NIST
* Created:      2/6/90
* Modified:     Sun Jun  5 03:49:10 1994 (Niels Mayer) npm@indeed
* Language:     C
* Package:      N/A
...
*******************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: /users/npm/src/winterp/src-server/expect/RCS/pty_sgi3.c,v 2.4 1994/06/06 15:43:06 npm Exp $";

/* pty_sgi.c - routines to allocate ptys - silicon graphics version
