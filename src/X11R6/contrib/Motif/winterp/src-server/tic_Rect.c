...
*
* File:         tic_Rect.c
* RCS:          $Header: /users/npm/src/winterp/src-server/RCS/tic_Rect.c,v 2.1 1994/06/06 15:41:05 npm Exp $
* Description:  TANGO:RECTANGLE_IMAGE_CLASS (subclass of TANGO:IMAGE_CLASS).
* Author:       Niels P. Mayer
* Created:      Sat May 15 21:44:11 1993
* Modified:     Sun Jun  5 14:29:06 1994 (Niels Mayer) npm@indeed
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: /users/npm/src/winterp/src-server/RCS/tic_Rect.c,v 2.1 1994/06/06 15:41:05 npm Exp $";
 ...
 * is used both by Tango_Rectangle_Image_Class_Method_ISNEW() and
 * Xtango_Create_Composite_Image()
 *******************************************************************************/
Boolean Xtango_Get_Rectangle_Image_Args(err_string, err_lval, loc_x_float, loc_y_float, lval_color,
 ...
 * ==========================================================================
 * TANGO_IMAGE
 * TANGOimage_create(TANGO_IMAGE_TYPE_RECTANGLE,lx,ly,vis,col,sx,sy,fill)
 *	double lx,ly;
 *	int vis;
 *	TANGO_COLOR col;
 *	double sx,sy,fill;
 ****************************************************************************/
LVAL Tango_Rectangle_Image_Class_Method_ISNEW()
{
  TANGO_IMAGE image;
  ...
  image = TANGOimage_create(TANGO_IMAGE_TYPE_RECTANGLE,
			    loc_x_float,
			    loc_y_float,
			    visible_p,
 ...
 * )
 ****************************************************************************/
LVAL Tango_Rectangle_Image_Get_Values(image)
     TANGO_IMAGE image;
{
  ...
  lval_fill = cvflonum((FLOTYPE) rectangle->fill);
  lval_result = cons(lval_fill, lval_result);

  lval_color = cvfixnum((FIXTYPE) rectangle->color);
  lval_result = cons(lval_color, lval_result);

  lval_size = newdcomplex((double) rectangle->size[0], (double) rectangle->size[1]);
 ...
 *	==> returns list (send TANGO:RECTANGLE_IMAGE_CLASS :new <visibility_kwd>
 *				*TANGO_WIDGET*
 *				#C(<location-x> <location-y)
 *				#C(<size-x> <size-y>)
 *				<tango_color>
 *				<fill_float>)
 ****************************************************************************/
LVAL Tango_Rectangle_Image_Class_Method_STOREON()
{
  ...
  lval_result = Tango_Rectangle_Image_Get_Values(image);
...
Tic_Rect_Init()
{
  LVAL o_TANGO_RECTANGLE_IMAGE_CLASS;

  /*--------------- create 'Class' instance 'TANGO:RECTANGLE_IMAGE_CLASS' ------------*/
  o_TANGO_RECTANGLE_IMAGE_CLASS =
    Tcls_Create_Subclass_Of_TANGOIMAGE_CLASS("TANGO:RECTANGLE_IMAGE_CLASS",
					     TANGO_IMAGE_TYPE_RECTANGLE);
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":ISNEW",
	   FTAB_Tango_Rectangle_Image_Class_Method_ISNEW);
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":STOREON",
  ...
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":IMAGE_LOC",
  ...
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":TX_COLOR",
   ...
   * thus can't add it to TANGO:IMAGE_CLASS metaclass... */
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":TX_FILL",
  ...
  xladdmsg(o_TANGO_RECTANGLE_IMAGE_CLASS, ":TX_RESIZE",
