...
;
; File:         subcalc.lsp
; RCS:          $Header: /users/npm/src/winterp/examples/RCS/subcalc.lsp,v 2.6 1994/06/06 14:43:04 npm Exp $
...
; Modified:     Sun Jun  5 19:17:26 1994 (Niels Mayer) npm@indeed
; Language:     Lisp
; Package:      N/A
...
(let (					;declare local variables
  ...
  (setq top-w
	(send TOP_LEVEL_SHELL_WIDGET_CLASS :new "subcalc"
	      ))
  (setq rc-w
