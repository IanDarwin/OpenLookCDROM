...
;
; File:         redir-out0.lsp
; RCS:          $Header: /users/npm/src/winterp/examples/lib-utils/RCS/redir-out0.lsp,v 2.1 1994/06/06 14:54:46 npm Exp $
; Description:  Motif 1.1 or Motif 1.0 version of redir-out.lsp. See
;		description in that file for details.
; Author:       Niels Mayer
; Created:      January 1992
; Modified:     Mon Jun  6 00:52:09 1994 (Niels Mayer) npm@indeed
; Language:     Lisp
...
(if *MOTIF-1.2-OR-LATER-P*
    (error "redir-out0.lsp is to be used with Motif 1.0 or 1.1 only -- use redir-out.lsp for Motif 1.2 or later.")
  )

;;; Icon stolen from HP Softbench
;;; Mwm*winterp-stdout-warn-shell*iconImage: usr/softbench/icons/action.h
	...
	(;; loc vars
	 (top-w
	  (send TOP_LEVEL_POPUP_SHELL_WIDGET_CLASS :new 
		...
		:XMN_TITLE		"WINTERP: Stdout Output Warning"
		:XMN_ICON_NAME		"W:redir-out0"
...
;;;	    :XMN_ICON_MASK		(xm_get_pixmap "/usr/local/include/X11/bitmaps-softbench/actionMask.h" "white" "black")
	 ...
	 (msg-label-w
	  (send XM_LABEL_GADGET_CLASS :new :managed
		...
		:XMN_LABEL_STRING	"Warning -- messages on stdout:"
