/*LINTLIBRARY*/
/*
 * SCCS_data:    @(#) TableLoc.c	1.9 92/11/17 14:32:06
 */
...
int XmpTableLocPreferredWidth( loc, tw )
    XmpTableLoc    loc;  	/* preferred size of widget in this loc	*/
    XmpTableWidget tw;  	/* The widget containing this loc	*/
{
...
int XmpTableLocPreferredHeight( loc, tw )
    XmpTableLoc    loc;  	/* preferred size of widget in this loc	*/
    XmpTableWidget tw;  	/* The widget containing this loc	*/
{
    if ( tw->table.resize_child == loc->w )
