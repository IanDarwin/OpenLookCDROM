/* $Id: drawticks.c,v 1.25 92/07/19 16:08:48 pturner Exp Locker: pturner $
 *
...
void create_ticklabel(form, prec, loc, s)
    int form, prec;
    double loc;
    char *s;
{
...
void drawyticklabels(gno, caxis)
    int gno, caxis;
{
    tickmarks t;
    world w;
