#ifndef lint
static char	sccsid[] = "@(#)group.c	2.23 91/08/14 Copyright 1991 Sun Microsystems";
#endif
	...
	Group	group_public;
{
	...
	group_set_xy(group_public, new_x, new_y);
}
	...
	Group_public	*group_public;
{
	...
	for (i = 0; group_private->members[i]; i++) {
		 ...
		 */
		/* This call causes a warning. Again an NULL within
		 the macro call not casted to Xv_opaque */
