 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/update.c,v 1.3 91/03/01 11:06:01 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/update.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/update.c,v $$Revision: 1.3 $";
      ...
      for(hold=x_cnt,i=0; i<x_cnt; i++) {
         ...
         if (!skip)  {
				if (i == hold) {		/* coel. across */
					...
					list = (struct rect_list *) alloc(sizeof(struct rect_list));
