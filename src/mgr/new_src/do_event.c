 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/do_event.c,v 1.3 91/03/01 11:05:46 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/do_event.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/do_event.c,v $$Revision: 1.3 $";
...
/* substitute %x into str, returns true if an area was swept. */

int
sub_event(win,str,c,swept,count,args)
register WINDOW *win;
register char *str,c;
...
/* write the event to a process */

write_event(win,str,list)
...
/* extract numeric argument from sweep events */

char *
event_args(str,count,args)
