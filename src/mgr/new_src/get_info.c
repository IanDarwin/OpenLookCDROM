 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/get_info.c,v 1.3 91/03/01 11:05:49 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/get_info.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/get_info.c,v $$Revision: 1.3 $";

/* return info to shell */
...
BITMAP *text;				/* window's text region */
   ...
   int count;				/* whatever */
   char font_buff[MAX_PATH];		/* space to store a path name */
