 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/do_buckey.c,v 1.3 91/03/01 11:05:45 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/do_buckey.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/do_buckey.c,v $$Revision: 1.3 $";
...
register unsigned char	c;
{
	...
	char		*index(), *print_flags(), *print_events(),
				*print_stack();
	char		*print_ps();
	FILE *popen();
...
/*	Given a WINDOW pointer, move that window to top.
*/
static
do_it(win)
register WINDOW *win;
...
topwin( winsetid, winnum )
register int	winsetid,
		winnum;
{
	register WINDOW	*win;
