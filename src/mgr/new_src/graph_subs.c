 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/graph_subs.c,v 1.3 91/03/01 11:05:52 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/graph_subs.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/graph_subs.c,v $$Revision: 1.3 $";

/* graphics subs  - mostly from the BLIT */

#include "bitmap.h"

/* circle of radius r centered at x1,y1 */
...
ellip1(screen, x0,y0, a, b, x1,y1, x2,y2, f)
...
nearby(x1,y1, x2,y2, rx, ry)
register int x1, y1, x2, y2;
int *rx, *ry;
   {
   long eps, exy, Labs();   /*integers but many bits*/
   int d, dy;
   register dx;
