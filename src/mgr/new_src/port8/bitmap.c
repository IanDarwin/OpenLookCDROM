...
/* allocate the display as a bitmap */
...
/* map bit_blits into mem_rops, caching 8 bit images as needed */
...
/* expand a 1 pit per pixel primary bitmap to 8 bits per pixel */
