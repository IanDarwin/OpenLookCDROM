 ...
 */
/*	$Header: /home/sau/mgr/nsrc/RCS/new_window.c,v 1.3 91/03/01 11:05:55 sau Exp Locker: sau $
	$Source: /home/sau/mgr/nsrc/RCS/new_window.c,v $
*/
static char	RCSid_[] = "$Source: /home/sau/mgr/nsrc/RCS/new_window.c,v $$Revision: 1.3 $";
...
/* insert a new window into the window list */
...
/* create a new window given coords */
...
/* create a new window given coords , with only 1/2 a ptty */
...
int fnt;
   {
   struct font *curr_font, *Get_font();
...
make_window(screen,x,y,dx,dy,fnt,start)
BITMAP *screen;
int x, y, dx, dy;
int fnt;
char *start;
...
/*
	Look through all the windows for the next available window set id.
*/
